...
import com.mibtech.nbadmin.models.CardsModel;
...
public class addCardFragement extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        spinner.setItems("Cards", "Tshirt", "Calendar", "Stationary", "Bags", "Keychain");
            ...
            case R.id.b_submit:
                if(!isEmpty(productid) && !isEmpty(cardName) && !isEmpty(cardimage) && !isEmpty(cardprice) && !isEmpty(carddesc)){
                    ...
                    if(isEmpty(cardName)){
                        ...
                        Toast.makeText(getContext(), "Please enter ProductId", Toast.LENGTH_SHORT).show();
    ...
    private void myNewCard(int pid, String name, String image, String desc, float price) {
        ...
        CardsModel movie = new CardsModel(pid,name,image,desc,price);
